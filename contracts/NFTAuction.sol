...
contract NFTAuction {
    ...
    constructor(address _nftCollection, address _user, address _market, address _analytics) {
    ...
    function bid(uint256 _tokenId, uint256 _auctionId, uint256 _amount) public payable{
